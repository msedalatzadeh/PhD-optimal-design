...
load('WIC-2mode&Alpha0&Cd-4&mu-1iterInfcu1')
subplot(2,1,1)
plot(r,J_fmin,'.');
hold on
Jo=min(J_fmin)
...
load('WIC-4mode&Alpha0&Cd-4&mu-1iterInfcu1')
plot(r,J_fmin,':');
hold on
Jo=min(J_fmin)
ro=r(find(J_fmin==Jo))
...
load('WIC-6mode&Alpha0&Cd-4&mu-1iterInfcu1')
plot(r,J_fmin,'-.');
hold on
Jo=min(J_fmin)
ro=r(find(J_fmin==Jo))
...
load('WIC-8mode&Alpha0&Cd-4&mu-1iterInfcu1')
plot(r,J_fmin,'--');
hold on
Jo=min(J_fmin)
ro=r(find(J_fmin==Jo))
...
load('WIC-10mode&Alpha0&Cd-4&mu-1iterInfcu1')
plot(r,J_fmin);
hold on
Jo=min(J_fmin)
ro=r(find(J_fmin==Jo))
